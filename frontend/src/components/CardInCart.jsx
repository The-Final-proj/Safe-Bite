  ...
  return (
    <div>
      <div className="bg-white rounded-3 border p-3 d-flex align-items center gap-3">
        <div
          className="rounded-2 bg-secondary-subtle flex-shrink-0 d-flex align-items-center justify-content-center"
        ...
        <div className="flex-grow-1">
          ...
          <div className="d-flex align-items-center gap-3 mt-3 flex-wrap">
            <div className="d-flex align-items-center border rounded-pill overflow-hidden">
              <button
                className="btn-btn-sm btn-light px-2 py-1 border-0"
            ...
            <button
              className="btn btn-sm btn-outline-danger rounded-pill px-3 ms-auto"
